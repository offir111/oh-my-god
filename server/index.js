...
כללים:
- reply: חובה עד 40 מילים בלבד. ספור — אם מגיע ל-40 עצור ושים המשך ב-continuation.
- continuation: רק אם ה-reply לא מספיק — הרחבה, הסבר נוסף, דוגמאות. אחרת: "" (ריק לחלוטין).
