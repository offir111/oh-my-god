...
2. תן הסברים מפורטים ומעמיקים — לא כותרות. כתוב הסברים מלאים עם תהליכים, סיבות, מספרים ודוגמאות.
3. reply = 40 המילים הראשונות בלבד. continuation = כל שאר ההסבר ללא הגבלה.
...
כללים:
- reply: 40 המילים הראשונות של הסבר מפורט ומלא — משפטים שלמים, תוכן אמיתי, לא כותרות.
- continuation: המשך ישיר של אותה תשובה — כל שאר הפרטים, תהליכים, מספרים, הקשרים. כתוב כמה שנדרש ללא הגבלה. אחרת: "" (ריק).
