/**
 * Builds launcher mipmaps from client/public/earth-ring-logo.png
...
const srcLogo = join(root, 'client/public/earth-ring-logo.png');
const resRoot = join(root, 'android/app/src/main/res');

const BG = 0x07070cff; // #07070c matches app header
...
async function main() {
  ...
  console.log('Wrote launcher mipmaps from earth-ring-logo.png');
}
